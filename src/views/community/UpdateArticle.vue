...
export default {
  ...
  methods: {
    ...
    updateArticle: function () {
      ...
      axios.put(`http://127.0.0.1:8000/community/${this.category}/article/${this.pickArticle.id}/`, {'title': this.pickArticle.title, 'content': this.pickArticle.content}, config)
        .then((res) => {
          console.log(res)
