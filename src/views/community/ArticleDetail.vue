...
export default {
  ...
  methods: {
    ...
    getArticle: function () {
      ...
      axios.get(`http://127.0.0.1:8000/community/${this.category}/article/${this.articleId}`, config)
        .then((res) => {
    ...
    deleteArticle: function (article) {
      const config = this.setToken()
      axios.delete(`http://127.0.0.1:8000/community/${this.category}/article/${article.id}/`, config)
        .then(() => {
